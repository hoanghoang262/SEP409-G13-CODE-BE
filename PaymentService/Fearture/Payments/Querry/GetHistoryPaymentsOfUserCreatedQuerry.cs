...
{
    public class GetHistoryPaymentsOfUserCreatedQuerry : IRequest<IActionResult>
    {
        public int Id { get; set; }
    }
    public class GetPaymentHandler : IRequestHandler<GetHistoryPaymentsOfUserCreatedQuerry, IActionResult>
    {
        ...
        public async Task<IActionResult> Handle(GetHistoryPaymentsOfUserCreatedQuerry request, CancellationToken cancellationToken)
        {

...
namespace UnitTest
{
    public class UpdateChapterTest
    {
        ...
        public UpdateChapterTest(ITestOutputHelper output)
        {
            _output = output;
        }
        ...
        public void UTC01_UpdateSuccess()
        {
            ...
            // Rest request
            var restRequest = new RestRequest("/api/ChapterModeration/UpdateChapter");
            string payload = $$"""
                {
                  "id": 1,
                  "name": "Examples chapter is edited",
                  "part": 1.1,
                  "isNew": true
                }
                """;
        ...
        [Fact]
        public void UTC04_InvalidNumber()
        {
            // Rest client
            var restClient = new RestClient(new RestClientOptions
            {
        ...
        [Fact]
        public void UTC05_InvalidChapter()
        {
            // Rest client
            var restClient = new RestClient(new RestClientOptions
            {

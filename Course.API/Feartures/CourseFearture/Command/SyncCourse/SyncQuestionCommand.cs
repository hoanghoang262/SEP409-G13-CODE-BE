...
{
    public class SyncQuestionCommand : IRequest<IActionResult>, IMapFrom<QuestionEvent>
    {
        ...
        public class asyncQuestionCommandHandler : IRequestHandler<SyncQuestionCommand, IActionResult>
        {
            ...
            public async Task<IActionResult> Handle(SyncQuestionCommand request, CancellationToken cancellationToken)
            {

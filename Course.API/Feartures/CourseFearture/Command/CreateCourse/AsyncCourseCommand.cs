...
{
    public class AsyncCourseCommand : IRequest<IActionResult>, IMapFrom<CourseEvent>
    {
        ...
        public class AsyncCourseCommandHandler : IRequestHandler<AsyncCourseCommand, IActionResult>
        {
            ...
            public async Task<IActionResult> Handle(AsyncCourseCommand request, CancellationToken cancellationToken)
            {

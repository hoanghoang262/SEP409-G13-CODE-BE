...
{
    public class AsyncChapterCommand : IRequest<IActionResult>, IMapFrom<ChapterEvent>
    {
        ...
        public class AsyncChapterHandler : IRequestHandler<AsyncChapterCommand, IActionResult>
        {
            ...
            public async Task<IActionResult> Handle(AsyncChapterCommand request, CancellationToken cancellationToken)
            {
